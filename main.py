...
def main():
    ...
    parser.add_argument("--demo", action="store_true", help="Use data/demo.db instead of your private data/app.db.")
    ...
    if args.demo:
        ...
        print("Demo mode — username: demo | password: demo-only-2026")
    initialize_database()
    ...
    LoginWindow(root)
    if args.demo:
        root.title("DQ Studio / Demo — synthetic data only")
    root.mainloop()
